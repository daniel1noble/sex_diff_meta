...
With these models, we are just including score as a moderator term to compare with the rest of the dataset (some of which has already been transformed, we just can't do that with scores). Model summaries are presented in Supplementary Table S15.
```{r}
...
Do effect sizes from monogamous or multiply-mating species differ? Model summaries presented in Supplementary Table S9.
```{r}
...
Do effect sizes from adults (sexually mature) or juveniles differ? Model summaries presented in Supplementary Table S10
```{r}
# make a table
  data.frame(pers_new %>%
...
Do effect sizes from wild animals or lab animals differ? Model summaries presented in Supplementary Table S11.
```{r}
# table
  data.frame(pers_new %>%
...
Do effect sizes collected in the wild or the lab differ? Model summaries presented in Supplementary Table S12.
```{r}
# table
  data.frame(pers_new %>%
...
Do effect sizes from observational or experimental study design differ? Model summaries presented in Supplementary Table S13.
```{r}
...
Model summaries are also presented in Supplementary Tables S16-S24. 
```{r}
...
Model summaries are presented in Supplementary Table S14.
```{r}
