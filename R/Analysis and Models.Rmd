...
get_pred_est_cont(MLMR_models_pers_SSD, pers_new$personality_trait, pers_new$SSD_index) # not working - doesn't recognise personality_trait???
...
# make a matrix of effect sizes (n) for each species for each personality trait to add to our plot!
  ...
  # add the heatmap data to our plot
gheatmap(p5, invert_matrix, offset = 12, 
         low = "white", high = "mediumseagreen", color=NULL, 
...
dev.new(width=7,height=5.5,noRStudioGD = TRUE) #this is in inches, I think you can change it to pixels but not cms?
```
