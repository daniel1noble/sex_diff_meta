...
```{r}
    ...
    # Check that all names in the phylogeny are also in the data
      ...
      tree_checks(taxa_data_list[[1]], tree_bird, "spp_name_phylo", type = "checks")
      ...
      for(i in colnames(other_groups)){
        ...
        prune_mammals <- tree_checks(taxa_data_list[[4]], trees[[3]], "spp_name_phylo", type = "prune")

        prune_invert <- tree_checks(taxa_data_list[[3]], trees[[2]], "spp_name_phylo", type = "prune")
