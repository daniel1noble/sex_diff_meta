...
# Just select the relevant columns for now to make life easier
  pers_new <- pers %>% 
          select(study_ID, year, species_name, SSD_index, taxo_group, data_type, personality_trait, male_n, male_mean, m_SE_to_SD, female_n, female_mean, f_SE_to_SD, depend, directionality, spp_name_phylo, mating_system, age, population, study_environment, study_type, score, proportion)
...
#lncvr
mammal_lncvr <- orchard_plot(smd_mods_pers[[4]], mod = "personality_trait", xlab = "lnCVR", angle = 45, alpha = 0.5, transfm = "none")
```
...
# make a matrix of effect sizes (n) for each species for each personality trait to add to our plot!
  ...
  # add the heatmap data to our plot
rep_plot <- gheatmap(p3, rep_matrix, offset = 20, width = 2,
            low = "white", high = "mediumseagreen", color=NULL, 
  ...
  # save it
  ggsave("reptilphylo.pdf", dpi = 300)
...
# make a matrix of effect sizes (n) for each species for each personality trait to add to our plot!
  ...
  # add the heatmap data to our plot
     fish_plot <- gheatmap(p4, fish_matrix, offset = 40, width = 2,
         low = "white", high = "mediumseagreen", color=NULL, 
         colnames_position="bottom", 
         colnames_angle=60, colnames_offset_y = 1, 
...
# make a matrix of effect sizes (n) for each species for each personality trait to add to our plot!
  ...
  # add the heatmap data to our plot
     invertplot <- gheatmap(p5, invert_matrix, offset = 30, 
         low = "white", high = "mediumseagreen", color=NULL, 
         colnames_position="bottom", 
...
# save plot
ggsave("invertphylo.pdf", dpi = 300)
