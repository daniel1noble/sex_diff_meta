---
title: "A meta-analysis of sex differences in animal personality: no evidence for greater male variability - Data checks, analysis and meta-a models" 
...
### NEW METHOD OF PUBLICATION BIAS FROM NAKAGAWA ET AL 2021 - PREPRINT
    ...
    # inverts still significant - suggests evidence of pub bias
...
```{r}
print(session_info(include_base = FALSE))
```
